...
from app.components.objets.obstacles_game import ObstacleManager,Bird,Cactus,Obstacle
...
class Game:
    def __init__(self):
        ...
        self.x_pos_bg = 0
        self.y_pos_bg = 360
        self.text = Text(SCREEN_WIDTH/2,20,50)
        ...
        self.cactus = Cactus(random.choice(["large", "small"]))
    ...
    def update(self):
        ...
        self.cactus.update(self.screen)
